...
else{var a=window.location.href,b=a.indexOf("#");a=a.substring(0,b);a=localStorage.getItem("pdf2html_view_hash_"+MD5(a));this.navigate_to_dest(a)}window.history.replaceState("",document.title,window.location.pathname)},cache_current_view_hash:function(){var a=pdf2htmlEX.defaultViewer.get_current_view_hash(),b=window.location.href,c=b.indexOf("#");b=b.substring(0,c);localStorage.setItem("pdf2html_view_hash_"+MD5(b),a);pdf2htmlEX.defaultViewer.schedule_cache_current_view_hash()},schedule_cache_current_view_hash:function(){setTimeout(this.cache_current_view_hash,
